package com.koreait.talktalk.client.util;

import com.koreait.talktalk.model.FilePath;
    ...
    private void setProfile(boolean isMine, String userName, int profileNum) {
        String right =
                "	    	<th style=\"text-align:" + align.get(isMine) + ";\">" +
                        ...
                        "			</th>" +
                        "   	    <th rowspan=\"2\">" +
                        "				<img src=\"file:"+ FilePath.PROFILEPATH.toString()+"hero"+profileNum+".png"+"\" height=\"40\" width=\"40\">" +
                        "			</th>";
        profile.put(true, right);

        String left =
                "   	    <th rowspan=\"2\">" +
                        "				<img src=\"file:"+FilePath.PROFILEPATH+"hero"+profileNum+".png"+"\" height=\"40\" width=\"40\">" +
                        "			</th>" +
                        "	    	<th style=\"text-align:" + align.get(isMine) + ";\">" +
                        userName +
                        "			</th>";
